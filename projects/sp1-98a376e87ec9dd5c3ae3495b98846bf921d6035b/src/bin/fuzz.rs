...
use beak_sp1_98a376e::backend::{run_backend_once, Sp1Backend, WorkerRequest, WorkerResponse};

const ZKVM_COMMIT: &str = "98a376e87ec9dd5c3ae3495b98846bf921d6035b";
...
fn write_inline_seed_jsonl(root: &Path, words: &[u32]) -> PathBuf {
    ...
    let path = dir.join(format!(".tmp-inline-sp1-98a376e-{ts}.jsonl"));
    let line = json!({
        "instructions": words,
        "metadata": {
            "source": "cli_bin",
