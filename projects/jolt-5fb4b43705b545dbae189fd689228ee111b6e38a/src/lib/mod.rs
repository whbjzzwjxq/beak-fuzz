...
pub const JOLT_COMMIT: &str = "5fb4b43705b545dbae189fd689228ee111b6e38a";
pub const JOLT_REPO_URL: &str = "https://github.com/a16z/jolt.git";
pub const JOLT_ORACLE_CODE_BASE: u32 = common::constants::RAM_START_ADDRESS as u32;
...
pub fn ensure_jolt_checkout(zkvm_dir: &Path) -> Result<(), String> {
    ...
    checkout.args(["-C", zkvm_dir.to_string_lossy().as_ref(), "checkout", "--force", JOLT_COMMIT]);
