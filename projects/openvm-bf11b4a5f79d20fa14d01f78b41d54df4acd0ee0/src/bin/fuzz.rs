...
use beak_openvm_bf11b4a5::backend::{
    run_backend_once, OpenVmBackend, WorkerRequest, WorkerResponse,
};

const ZKVM_COMMIT: &str = "bf11b4a5f79d20fa14d01f78b41d54df4acd0ee0";
    ...
    let matches = Command::new("beak-fuzz")
        ...
        .arg(
            Arg::new("mutation_iters")
                ...
                .default_value("0")
                .help(
                "Number of feedback-guided mutation iterations after initial corpus evaluation.",
            ),
        )
        .arg(
