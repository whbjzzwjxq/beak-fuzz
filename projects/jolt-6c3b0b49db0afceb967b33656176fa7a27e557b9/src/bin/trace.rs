...
use beak_jolt_6c3b0b49::backend::run_backend_once;
use beak_jolt_6c3b0b49::JOLT_ORACLE_CODE_BASE;

fn main() {
    let matches = Command::new("beak-trace")
        .about("Run oracle vs vulnerable Jolt 6c backend and optionally print derived buckets.")
        .arg(
            Arg::new("bin")
                .long("bin")
        ...
        .arg(
            Arg::new("print_buckets")
                .long("print-buckets")
                .help("Parse collected feedback and print derived bucket hits.")
                .action(clap::ArgAction::SetTrue),
        )
        .arg(
            Arg::new("inject_kind")
                .long("inject-kind")
                .help("Explicit witness injection kind. Unsupported for this snapshot.")
                .num_args(1),
        )
        .arg(
            Arg::new("inject_step")
                .long("inject-step")
                .default_value("0")
                .help("Injection step. Unsupported for this snapshot."),
        )
        .arg(
