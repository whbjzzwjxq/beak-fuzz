...
pub enum Sp1BucketId {
    ...
    #[strum(serialize = "sp1.sem.row.padding_interaction_send")]
    SemRowPaddingInteractionSend,
    #[strum(serialize = "sp1.sem.memory.kind_selector_consistency")]
    SemMemoryKindSelectorConsistency,
    #[strum(serialize = "sp1.sem.control.ecall_next_pc")]
    SemControlEcallNextPc,
    #[strum(serialize = "sp1.sem.interaction.digest_kind_route")]
    SemInteractionDigestKindRoute,
}
