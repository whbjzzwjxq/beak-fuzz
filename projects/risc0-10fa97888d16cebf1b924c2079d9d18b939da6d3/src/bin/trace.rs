...
use beak_risc0_10fa9788::backend::run_backend_once;
use beak_risc0_10fa9788::trace::Risc0Trace;
use beak_risc0_10fa9788::RISC0_ORACLE_CODE_BASE;

fn main() {
    std::thread::Builder::new()
        .name("beak-risc0-trace".to_string())
        .stack_size(256 * 1024 * 1024)
        .spawn(run)
        .expect("spawn beak-trace worker")
        .join()
        .expect("beak-trace worker panicked");
}
