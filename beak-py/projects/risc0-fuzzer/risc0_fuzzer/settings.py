...
RISC0_BENCHMARK_COMMIT = "10fa97888d16cebf1b924c2079d9d18b939da6d3"
RISC0_V2_0_2_COMMIT = "c0db0713671c8ec467b3efc26b22a0b0591897ff"
...
def resolve_risc0_commit(commit_or_branch: str) -> str:
    if commit_or_branch == RISC0_BENCHMARK_ALIAS:
        return RISC0_BENCHMARK_COMMIT
    if commit_or_branch == RISC0_V2_0_2_ALIAS:
        return RISC0_V2_0_2_COMMIT
