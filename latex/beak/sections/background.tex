...
\paragraph{Invariant-critical conditions}
Constraint bugs cluster at \emph{invariant-critical conditions}---limb-crossing immediates, address-space limits, division by zero, signed overflow---that are rare in typical executions and hard to reach by random testing.
